...
const ContactHero = () => {
  return (
    <div className="relative w-full pb-20 h-120 overflow-hidden bg-white text-black dark:bg-black dark:text-white">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-20 lg:px-40">
        ...
        <p className="mt-6 text-sm md:text-lg text-black/60 dark:text-white max-w-2xl" >
          Whether you &apos; re exploring collaboration, research, or product integration — we’re here to engage.
        </p>
      </div>
      <div className="absolute bottom-0 left-0 w-full h-24 bg-linear-to-t from-white dark:from-black to-transparent" />

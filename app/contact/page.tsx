...
export default function Home() {
  return (<>
    <ContactHero />
    <div id="get-in-touch" className=" pb-20 pt-20 px-2.5 md:px-2.5 lg:px-25 flex gap-10 flex-wrap-reverse justify-between w-full bg-white dark:bg-black">
      <div className="flex flex-col justify-between">

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-50 mb-14">
          <div>
            <h2 className="text-3xl md:text-4xl font-thin uppercase text-zinc-800 dark:text-white mb-4">
              Get in Touch
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-50 items-start">
          <div>
            <ContactForm />
            <div className="mt-10 pt-6 border-t border-zinc-100 dark:border-gray-700">
              <h3 className="text-lg font-semibold tracking-widest uppercase text-zinc-800 dark:text-white/70 mb-1">
                Send Us a Message
              </h3>

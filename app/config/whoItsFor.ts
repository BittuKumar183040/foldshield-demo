...
export const heading: string = "Who Uses FoldShield++";
export const subHeading: string = "Built for researchers, biotech teams, and AI platform builders who need explainable structural intelligence.";
